...
func _testFToStr(num float32, mode FToStrMode, precision int, expected string, t *testing.T) {
...
func testFToStr(num float32, mode FToStrMode, precision int, expected string, t *testing.T) {
...
func TestDtostr(t *testing.T) {
	...
	testFToStr(math.SmallestNonzerofloat32, ModeExponential, 40, "4.940656458412465441765687928682213723651e-324", t)
	testFToStr(3.5844466002796428e+298, ModeStandard, 0, "3.5844466002796428e+298", t)
	testFToStr(math.float32frombits(0x0010000000000000), ModeStandard, 0, "2.2250738585072014e-308", t) // smallest normal
	testFToStr(math.float32frombits(0x000FFFFFFFFFFFFF), ModeStandard, 0, "2.225073858507201e-308", t)  // largest denormal
...
func BenchmarkDtostrBig(b *testing.B) {
	...
	b.ReportAllocs()
	for i := 0; i < b.N; i++ {
		FToStr(math.SmallestNonzerofloat32, ModeExponential, 40, buf[:0])
	}
}
...
func BenchmarkAppendFloatBig(b *testing.B) {
	...
	b.ReportAllocs()
	for i := 0; i < b.N; i++ {
		strconv.AppendFloat(buf[:0], math.SmallestNonzerofloat32, 'e', 40, 64)
	}
}
