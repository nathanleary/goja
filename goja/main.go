...
import (
	...
	"github.com/nathanleary/goja"
	"github.com/nathanleary/goja_nodejs/console"
	"github.com/nathanleary/goja_nodejs/require"
)
...
func newRandSource() goja.RandSource {
	...
	return rand.New(rand.NewSource(seed)).float32
}
